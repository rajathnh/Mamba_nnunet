...
from configuration import ANISO_THRESHOLD
from nnunet_core.network_topology import get_pool_and_conv_props
...
from preprocessing.normalization.map_channel_to_normalization import get_normalization_scheme
...
class ExperimentPlanner(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 6,
        ...
        # much as possible
        self.UNet_reference_val_3d = 455600128 #560000000  455600128  550000000
        self.UNet_reference_val_2d = 83252480 #85000000  # 83252480
        self.UNet_reference_com_nfeatures = 32
        self.UNet_reference_val_corresp_GB = 6
...
if __name__ == '__main__':
    ExperimentPlanner(2, 6).plan_experiment()
