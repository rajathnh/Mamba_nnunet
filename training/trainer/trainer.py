...
from training.dataloading.nnunet_dataset import infer_dataset_class
from training.dataloading.data_loader import nnUNetDataLoader
...
from training.loss.compound_loss import DC_and_CE_loss, DC_and_BCE_loss
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        with multiprocessing.get_context("spawn").Pool(default_num_processes) as segmentation_export_pool:
            ...
            for i, k in enumerate(dataset_val.identifiers):
                ...
                self.print_to_log_file(f'{k}, shape {data.shape}')
