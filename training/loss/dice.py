...
from utilities.ddp_allgather import AllGatherGrad

class SoftDiceLoss(nn.Module):
    def __init__(self,apply_nonlin:Callable=None,batch_dice :bool = False,do_bg : bool=True,smooth:float = 1.,ddp:bool=True,clip_tp: float = None):    
...
if __name__ == '__main__':
    from utilities.helpers import softmax_helper_dim1
